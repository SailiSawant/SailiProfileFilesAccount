# For 9293:
# Author: Saili Sawant
# Code name: pythoncode2.py

# Objective: To insert the records of 9091 data into the table using python
...
cursor = conn.cursor()
with open('9293.txt','r',encoding='latin_1') as input:          #Get the data
	for line in input:
		us_wthsid = line[4:10]
